 ...
 *
 * PURPOSE:
 * This program ensures the executed audio player binary runs in a
 * deterministic, low-jitter environment critical for two goals:
 ...
 * - OOM Protection: Prevents the Out-of-Memory killer from terminating the
 * process.
 * - Fixed Environment: Guarantees a consistent stack pointer address for
